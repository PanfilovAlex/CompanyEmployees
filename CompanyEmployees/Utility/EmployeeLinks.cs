...
namespace CompanyEmployees.Utility
{
    public class EmployeeLinks
    {
            ...
            Guid companyId, HttpContext httpContext, List<Entity> shapedEmployees)
        {
            ...
            {
                var employeeLinks = CreateLinksForEmployees(httpContext, companyId, employeeDtoList[index].Id, fields);
        ...
        private bool ShouldGenerateLinks(HttpContext httpContext)
        {
            ...
            var result = mediaType.SubTypeWithoutSuffix.EndsWith("hateoas", StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
